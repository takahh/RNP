...
plt.hist(df['all_chains'], bins=30, range=(0, 3))
plt.show()
plt.close()
...
reso25list = resolution_list(3).keys().values
ch2list = df_2['vec_id'].tolist()
print(reso25list)
print(ch2list)

ch2_reso25list = [x for x in ch2list if x[0:4] in reso25list]
print(ch2_reso25list)

plt.hist(ch2_reso25list, bins=30, range=(0, 3))
plt.show()
plt.close()
