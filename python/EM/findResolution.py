...
# constants
# ----------------------------------------------------------
path = '/Users/tkimura/Desktop/RNP/downloads_PDB/EM_cif/'
reso_summary = '/Users/tkimura/Desktop/RNP/filterEM/reso_summary.csv'
reso_list = []
		...
		if '.cif' in files:
			...
			with open(path + files) as f:
				for lines in f.readlines():
					try:
						if 'eflns.d_resolution_high' in lines:
							print('1')
							print(lines)
							reso = lines.split()[1]
							break
