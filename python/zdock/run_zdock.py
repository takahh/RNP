...
for id in idlist:
	...
	# preprocess
	command = 'mark_sur ' + path + 'pdb/' + pdbid + '/' + pdbid + '_p.pdb ' + path + 'pdb/' + pdbid + '/' + pdbid + '_p_m.pdb'
	subprocess.call([command], shell=True)
	command = 'mark_sur ' + path + 'pdb/' + pdbid + '/' + pdbid + '_r.pdb ' + path + 'pdb/' + pdbid + '/' + pdbid + '_r_m.pdb'
	subprocess.call([command], shell=True)
	command = 'zdock -o ' + path + 'outs/' + pdbid + '.out -N 10000 -R ' + path + 'pdb/' + pdbid + '/' + pdbid + '_p_m.pdb -L ' + path + 'pdb/' + pdbid + '/' + pdbid + '_r_m.pdb'
	subprocess.call([command], shell=True)
